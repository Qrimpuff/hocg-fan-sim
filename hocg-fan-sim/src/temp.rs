            ...
            cards: [
                ...
                (
                    ...
                    Card::Cheer(CheerCard {
                        ...
                        illustration_url: "https://github.com/Qrimpuff/hocg-fan-sim-assets/raw/main/img/hY01/hY01-001.webp".into(),
                        artist: "はずき".into(),
                    }),
                ),
                (
                    ...
                    Card::Cheer(CheerCard {
                        ...
                        text: "⯀ When a holomem leaves the stage, archive all Cheer cards attached to them.\n⯀ When a holomem Baton Passes, archive a number of Cheer cards attached to them equal to the Baton Pass cost.".into(),
                        rarity: Rarity::Common,
                        illustration_url: "https://github.com/Qrimpuff/hocg-fan-sim-assets/raw/main/img/hY02/hY02-001.webp".into(),
                        artist: "はずき".into(),
                    }),
                ),
                (
                    ...
                    Card::Cheer(CheerCard {
                        ...
                        text: "⯀ When a holomem leaves the stage, archive all Cheer cards attached to them.\n⯀ When a holomem Baton Passes, archive a number of Cheer cards attached to them equal to the Baton Pass cost.".into(),
                        rarity: Rarity::Common,
                        illustration_url: "https://github.com/Qrimpuff/hocg-fan-sim-assets/raw/main/img/hY03/hY03-001.webp".into(),
                        artist: "はずき".into(),
                    }),
                ),
                (
                    ...
                    Card::Cheer(CheerCard {
                        ...
                        text: "⯀ When a holomem leaves the stage, archive all Cheer cards attached to them.\n⯀ When a holomem Baton Passes, archive a number of Cheer cards attached to them equal to the Baton Pass cost.".into(),
                        rarity: Rarity::Common,
                        illustration_url: "https://github.com/Qrimpuff/hocg-fan-sim-assets/raw/main/img/hY04/hY04-001.webp".into(),
                        artist: "はずき".into(),
                    }),
                ),
                ...
                (
                    ...
                    Card::OshiHoloMember(OshiHoloMemberCard {
                        ...
                        illustration_url: "https://github.com/Qrimpuff/hocg-fan-sim-assets/raw/main/img/hSD01/hSD01-001.webp".into(),
                        artist: "でいりー".into(),
                    }),
                ),
                (
                    ...
                    Card::OshiHoloMember(OshiHoloMemberCard {
                        ...
                        rarity: Rarity::OshiSuperRare,
                        illustration_url: "https://github.com/Qrimpuff/hocg-fan-sim-assets/raw/main/img/hSD01/hSD01-002.webp".into(),
                        artist: "Hachi".into(),
                    }),
                ),
                // Members
                (
                    ...
                    Card::HoloMember(HoloMemberCard {
                        ...
                        attributes: vec![],
                        rarity: Rarity::Common,
                        illustration_url: "https://github.com/Qrimpuff/hocg-fan-sim-assets/raw/main/img/hSD01/hSD01-003.webp".into(),
                        artist: "はこに".into(),
                    }),
                ),
                (
                    ...
                    Card::HoloMember(HoloMemberCard {
                        ...
                        attributes: vec![],
                        rarity: Rarity::Rare,
                        illustration_url: "https://github.com/Qrimpuff/hocg-fan-sim-assets/raw/main/img/hSD01/hSD01-004.webp".into(),
                        artist: "".into(),
                    }),
                ),
                (
                    ...
                    Card::HoloMember(HoloMemberCard {
                        ...
                        illustration_url: "https://github.com/Qrimpuff/hocg-fan-sim-assets/raw/main/img/hSD01/hSD01-005.webp".into(),
                        artist: "おるだん".into(),
                    }),
                ),
                (
                    ...
                    Card::HoloMember(HoloMemberCard {
                        ...
                        illustration_url: "https://github.com/Qrimpuff/hocg-fan-sim-assets/raw/main/img/hSD01/hSD01-006.webp".into(),
                        artist: "I☆LA".into(),
                    }),
                ),
                (
                    ...
                    Card::HoloMember(HoloMemberCard {
                        ...
                        attributes: vec![],
                        rarity: Rarity::Common,
                        illustration_url: "https://github.com/Qrimpuff/hocg-fan-sim-assets/raw/main/img/hSD01/hSD01-007.webp".into(),
                        artist: "".into(),
                    }),
                ),
                (
                    ...
                    Card::HoloMember(HoloMemberCard {
                        ...
                        attributes: vec![],
                        rarity: Rarity::Common,
                        illustration_url: "https://github.com/Qrimpuff/hocg-fan-sim-assets/raw/main/img/hSD01/hSD01-008.webp".into(),
                        artist: "はこに".into(),
                    }),
                ),
                (
                    ...
                    Card::HoloMember(HoloMemberCard {
                        ...
                        attributes: vec![],
                        rarity: Rarity::Rare,
                        illustration_url: "https://github.com/Qrimpuff/hocg-fan-sim-assets/raw/main/img/hSD01/hSD01-009.webp".into(),
                        artist: "".into(),
                    }),
                ),
                (
                    ...
                    Card::HoloMember(HoloMemberCard {
                        ...
                        attributes: vec![],
                        rarity: Rarity::Uncommon,
                        illustration_url: "https://github.com/Qrimpuff/hocg-fan-sim-assets/raw/main/img/hSD01/hSD01-010.webp".into(),
                        artist: "".into(),
                    }),
                ),
                (
                    ...
                    Card::HoloMember(HoloMemberCard {
                        ...
                        attributes: vec![],
                        rarity: Rarity::DoubleRare,
                        illustration_url: "https://github.com/Qrimpuff/hocg-fan-sim-assets/raw/main/img/hSD01/hSD01-011.webp".into(),
                        artist: "I☆LA".into(),
                    }),
                ),
                (
                    ...
                    Card::HoloMember(HoloMemberCard {
                        ...
                        attributes: vec![],
                        rarity: Rarity::Common,
                        illustration_url: "https://github.com/Qrimpuff/hocg-fan-sim-assets/raw/main/img/hSD01/hSD01-012.webp".into(),
                        artist: "".into(),
                    }),
                ),
                (
                    ...
                    Card::HoloMember(HoloMemberCard {
                        ...
                        rarity: Rarity::Rare,
                        illustration_url: "https://github.com/Qrimpuff/hocg-fan-sim-assets/raw/main/img/hSD01/hSD01-013.webp".into(),
                ...
                (
                    ...
                    Card::HoloMember(HoloMemberCard {
                        ...
                        attributes: vec![],
                        rarity: Rarity::Uncommon,
                        illustration_url: "https://github.com/Qrimpuff/hocg-fan-sim-assets/raw/main/img/hSD01/hSD01-014.webp".into(),
                        artist: "".into(),
                    }),
                ),
                (
                    ...
                    Card::HoloMember(HoloMemberCard {
                        ...
                        attributes: vec![],
                        rarity: Rarity::Uncommon,
                        illustration_url: "https://github.com/Qrimpuff/hocg-fan-sim-assets/raw/main/img/hSD01/hSD01-015.webp".into(),
                        artist: "".into(),
                    }),
                ),
                // items
                (
                    ...
                    Card::Support(SupportCard {
                        ...
                        rarity: Rarity::Common,
                        illustration_url: "https://github.com/Qrimpuff/hocg-fan-sim-assets/raw/main/img/hSD01/hSD01-016.webp".into(),
                        artist: "Yoshimo".into(),
                    }),
                ),
                (
                    ...
                    Card::Support(SupportCard {
                        ...
                        effect: test_effect(r"
                            ...
                            ").parse_effect().expect("hSD01-017"),
                        rarity: Rarity::Common,
                        illustration_url: "https://github.com/Qrimpuff/hocg-fan-sim-assets/raw/main/img/hSD01/hSD01-017.webp".into(),
                ...
                (
                    ...
                    Card::Support(SupportCard {
                        ...
                        rarity: Rarity::Common,
                        illustration_url: "https://github.com/Qrimpuff/hocg-fan-sim-assets/raw/main/img/hSD01/hSD01-018.webp".into(),
                ...
                (
                    ...
                    Card::Support(SupportCard {
                        ...
                        effect: test_effect(r"
                            ...
                            ").parse_effect().expect("hSD01-019"),
                        rarity: Rarity::Common,
                        illustration_url: "https://github.com/Qrimpuff/hocg-fan-sim-assets/raw/main/img/hSD01/hSD01-019.webp".into(),
                ...
                (
                    ...
                    Card::Support(SupportCard {
                        ...
                        rarity: Rarity::Common,
                        illustration_url: "https://github.com/Qrimpuff/hocg-fan-sim-assets/raw/main/img/hSD01/hSD01-020.webp".into(),
                        artist: "JinArt KABAKURA".into(),
                    }),
                ),
                (
                    ...
                    Card::Support(SupportCard {
                        ...
                        effect: test_effect(r"
                            ...
                            ").parse_effect().expect("hSD01-021"),
                        rarity: Rarity::Common,
                        illustration_url: "https://github.com/Qrimpuff/hocg-fan-sim-assets/raw/main/img/hSD01/hSD01-021.webp".into(),
                        artist: "".into(),
                    }),
                ),
            ]
