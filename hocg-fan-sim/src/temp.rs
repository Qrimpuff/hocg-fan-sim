            ...
            cards: [
                ...
                (
                    ...
                    Card::Cheer(CheerCard {
                        ...
                        text: "⯀ When a holomem leaves the stage, archive all Cheer cards attached to them.\n⯀ When a holomem Baton Passes, archive a number of Cheer cards attached to them equal to the Baton Pass cost.".into(),
                        rarity: Rarity::Common,
                        illustration_url: "https://qrimpuff.github.io/hocg-fan-sim-assets/img/hY02/hY02-001.webp".into(),
                        artist: "はずき".into(),
                    }),
                ),
                (
                ...
                (
                    ...
                    Card::HoloMember(HoloMemberCard {
                        ...
                        attributes: vec![],
                        rarity: Rarity::Common,
                        illustration_url: "https://qrimpuff.github.io/hocg-fan-sim-assets/img/hSD01/hSD01-003.webp".into(),
                        artist: "はこに".into(),
                    }),
                ),
                (
                ...
                (
                    ...
                    Card::HoloMember(HoloMemberCard {
                        ...
                        illustration_url: "https://qrimpuff.github.io/hocg-fan-sim-assets/img/hSD01/hSD01-005.webp".into(),
                        artist: "おるだん".into(),
                    }),
                ),
                (
                ...
                (
                    ...
                    Card::HoloMember(HoloMemberCard {
                        ...
                        attributes: vec![],
                        rarity: Rarity::Uncommon,
                        illustration_url: "https://qrimpuff.github.io/hocg-fan-sim-assets/img/hSD01/hSD01-010.webp".into(),
                        artist: "".into(),
                    }),
                ),
                (
